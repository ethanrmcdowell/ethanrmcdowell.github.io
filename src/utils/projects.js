const projects = [
  {
    ...
    href: 'http://ethanrmcdowell.github.io/covid-watcher',
    github: 'https://github.com/ethanrmcdowell/covid-watcher',
    img: '/images/coviddash.jpg',
    alt: 'covid dashboard demo image',
    class: 'portfolio-one',
    video: 'https://youtu.be/BWePZkCxAJI',
    technologies: 'JavaScript, React, Redux, Chart.js, Axios, Disease.sh',
    description:
  ...
  },
  {
    ...
    href: 'https://choose-adventure.herokuapp.com/',
    github: 'https://github.com/ethanrmcdowell/choose-adventure',
    img: '/images/chooseadventure.jpg',
    alt: 'choose adventure demo image',
    class: 'portfolio-two',
    video: 'https://youtu.be/lQFMzYWtKWg',
    technologies:
      'JavaScript, Heroku, Express, React, Node, MongoDB, Passport.js, Howler.js',
    description:
  ...
  },
  {
    ...
    github: 'https://github.com/ethanrmcdowell/vehicle-dashboard',
    img: '/images/vehicledash.jpg',
    alt: 'vehicle dashboard demo image',
    class: 'portfolio-three',
    video: '',
    technologies: 'React Google Maps, Google Maps API, Bootstrap',
    description:
  ...
  },
  {
    ...
    href: 'https://calm-coast-89616.herokuapp.com/',
    github: 'https://github.com/ethanrmcdowell/Workout-Tracker',
    img: '/images/fitness.jpg',
    alt: 'workout tracker demo image',
    class: 'portfolio-five',
    video: '',
    technologies: 'JavaScript, Express, Node, MongoDB',
    description:
  ...
  },
  {
    ...
    href: 'https://desolate-bastion-02201.herokuapp.com/',
    github: 'https://github.com/ethanrmcdowell/Budget-Tracker',
    img: '/images/budget.jpg',
    alt: 'budget tracker demo image',
    class: 'portfolio-six',
    video: '',
    technologies: 'Javascript, jQuery, Express, Node, Mongoose',
    description:
